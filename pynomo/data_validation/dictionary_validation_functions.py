...
def check_type_6_axis_params(field, value, error):
    # TODO run checker for type 6 axis params
    check_general_axis_params(field, value, error)
...
def check_text_format_string(field, value, error):
    # TODO: check text-format string (check also for string) is correct format
    pass
...
block_schema = {
    ...
    'height': {'required': False, 'type': {'allowed': ['float', 'integer']}},
    'width': {'required': False, 'type': {'allowed': ['float', 'integer']}},
    'reference_padding': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 3
    'reference_titles': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 3
    'reference_color': {'required': False},  # type 3
    'padding': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 4
    ...
    'u_title_x_shift': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'u_title_y_shift': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    ...
    'u_title_distance_center': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    ...
    'u_align_x_offset': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'u_align_y_offset': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'u_text_format': {'required': False, 'type': 'string'},  # type 5
    'u_extra_params': {'required': False, 'type': 'dict'},  # type 5
    'u_text_distance_0': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'u_text_distance_1': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'u_text_distance_2': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'u_text_distance_3': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'u_text_distance_4': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'u_grid_length_0': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'u_grid_length_1': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'u_grid_length_2': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'u_grid_length_3': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'u_grid_length_4': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    ...
    'u_extra_angle': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    ...
    'v_title_distance_center': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    ...
    'wd_title_x_shift': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'wd_title_y_shift': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    ...
    'wd_title_distance_center': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    ...
    'wd_align_x_offset': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'wd_align_y_offset': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'wd_text_format': {'required': False, 'type': 'string'},  # type 5
    'wd_extra_params': {'required': False, 'type': 'dict'},  # type 5
    'wd_text_distance_0': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'wd_text_distance_1': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'wd_text_distance_2': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'wd_text_distance_3': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'wd_text_distance_4': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'wd_grid_length_0': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'wd_grid_length_1': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'wd_grid_length_2': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'wd_grid_length_3': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    'wd_grid_length_4': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    ...
    'wd_extra_angle': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 5
    ...
    'x_empty': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 6
    'y_empty': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 6
    'curve_const': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 6
    'ladder_color': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 6
    'angle_u': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 7
    'angle_v': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 7
...
axis_schema = {
    ...
    'u_min': {'required': True, 'type': {'allowed': ['float', 'integer']}},  # 0.1,
    'u_max': {'required': True, 'type': {'allowed': ['float', 'integer']}},  # 1.0,
    'u_min_trafo': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 9
    'u_max_trafo': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # type 9
    ...
    'title_x_shift': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # 0.0,
    'title_y_shift': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # 0.25,
    ...
    'tick_text_levels': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # 10,
    ...
    'reference_padding': {'required': False, 'type': {'allowed': ['float', 'integer']}},
    # 0.20,  # fraction of reference line over other lines
    'manual_axis_data': {'required': False, 'type': 'dict'},  # {},
    'title_distance_center': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # 0.5,
    ...
    'align_x_offset': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # 0.0,
    'align_y_offset': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # 0.0,
    'aligned': {'required': False, 'type': 'boolean'},  # False,
    'base_start': {'required': False, 'type': {'allowed': ['float', 'integer']}, 'nullable': True},
    # None,
    'base_stop': {'required': False, 'type': {'allowed': ['float', 'integer']}, 'nullable': True},
    # None,
    'scale_max': {'required': False, 'type': {'allowed': ['float', 'integer']}, 'nullable': True},
    # None,
    'extra_params': {'required': False, 'type': 'list'},  # [],  # additional axis params
    'debug': {'required': False, 'type': 'boolean'},  # False,  # print dictionary
    'tick_distance_smart': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # 0.05,
    'full_angle': {'required': False, 'type': 'boolean'},  # False,
    'extra_angle': {'required': False, 'type': {'allowed': ['float', 'integer']}},  # 0.0,
